...
void CMediaLibItemPropertiesDlg::InitData()
{
    ...
    m_items.emplace_back(theApp.m_str_table.LoadText(L"TXT_LIB_PROPERTIES_LAST_PLAYED_POSITION"), CPlayTime(m_item_info.last_position).toString());
    ...
    m_items.emplace_back(theApp.m_str_table.LoadText(L"TXT_TOTAL_LENGTH"), CPlayTime(m_item_info.total_time).toString3());
