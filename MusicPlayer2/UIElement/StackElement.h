...
namespace UiElement
{
    ...
    public:
        ...
        CRect GetIndicatorRect() const { return indicator.rect; }
        bool IsHoverSwitch() const { return hover_to_switch; }
        bool IsSizeChangeSwitch() const { return size_change_to_switch; }
